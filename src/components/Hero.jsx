  ...
  return (
    ...
    >
      ...
      >
        ...
        <h1 className="w-full font-poppins font-semibold ss:text-[68px] text-[52px] text-white ss:leading-[100px] leading-[72px]">
          Payment Method
        </h1>
      ...
      <div className={`${styles.flexCenter} flex-1 flex md:my-0 my-10 relative `}>
        ...
        <div className=" absolute z-[1] w-[80%] bottom-40 rounded-full h-[80%] white__gradient " />
        <div className=" absolute z-[0] w-[50%] right-20 bottom-20 h-[45%] blue__gradient " />
      </div>
    </section>
  );
};
